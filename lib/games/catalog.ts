...
export const gameCatalog: GameDefinition[] = [
  ...
  },
  {
    ...
    status: '已可试玩',
    summary: '当前已支持 7 种方块、自动下落、旋转移动、消行计分、下一块预览和最高分保存。',
    description: '现在已经可以直接游玩，后续还可以继续补暂停、持有方块、音效和更细的旋转修正。',
    placeholderTitle: '俄罗斯方块游戏区占位',
    placeholderDescription: '这里将承载方块地图、下一个方块预览和游戏状态栏。',
    tags: ['实时下落', '碰撞检测', '消行计分'],
    controls: ['方向键或 WASD 控制移动', '上键或 W 旋转，下键或 S 加速下落', '空格可直接硬降到底'],
    todo: ['补暂停功能', '补持有方块', '补更完整的旋转墙踢规则'],
  },
  {
    slug: 'snake',
    name: '贪吃蛇',
  ...
  },
  {
    ...
    status: '已可试玩',
    summary: '当前已支持单花色发牌、点击选牌、合法列移动、补牌和完整顺子自动收走。',
    description: '现在已经可以直接游玩，后续可继续补拖拽、撤销、双花色和四色模式。',
    placeholderTitle: '蜘蛛纸牌游戏区占位',
    placeholderDescription: '这里后续将放 10 列牌堆、发牌区和已完成牌组区域。',
    tags: ['牌组规则', '单花色优先', '复杂交互'],
    controls: ['点击一段递减顺子后，再点目标列完成移动', '点击补牌按钮可向每列发 1 张牌', '支持重新开始和胜利判断'],
    todo: ['补拖拽交互', '补撤销功能', '补双花色和四色模式'],
  },
  {
    slug: 'minesweeper',
    name: '扫雷',
    ...
    status: '已可试玩',
    summary: '当前已支持难度切换、首击安全、右键插旗、连片展开和计时。',
    description: '现在已经可以直接游玩，后续可继续补双击数字开格、移动端标旗模式和更细的动画反馈。',
    placeholderTitle: '扫雷游戏区占位',
    placeholderDescription: '这里后续将承载棋盘、剩余雷数、计时器和胜负提示。',
    tags: ['首击安全', '插旗', '自动展开'],
    controls: ['左键翻开格子', '右键插旗', '支持难度切换、重新开始和最佳时间保存'],
    todo: ['补双击数字快速开格', '补移动端标旗模式', '补更细的翻格动画'],
  },
];
